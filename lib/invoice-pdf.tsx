...
async function toUint8Array(body: unknown): Promise<Uint8Array> {
  ...
  if (
    typeof anyBody?.byteLength === "number" &&
    typeof anyBody?.slice === "function" &&
    typeof anyBody?.toString === "function"
  ) {
...
export async function buildInvoicePdfBuffer(data: InvoiceData, logoUrl: string): Promise<Uint8Array> {
